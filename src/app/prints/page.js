  ...
  return (
    <>
      <style jsx>{`
        ...
        /* ─────────────────────────────────────────────────────────
           THE FIX: outer wrapper is position:relative.
           Skeleton is position:absolute (NOT fixed) anchored to it.
           This means skeleton & content scroll together — identical
           to how ads.tsx works. No jump, no scroll reset needed.
        ───────────────────────────────────────────────────────── */
        .page-root {
          position: relative;
          overflow-x: hidden;
        ...
        /*
          SKELETON — position:absolute so it overlays the real content
          without adding to document height.
          height:100% + overflow:hidden clips it to exactly the content's
          height, so there's zero extra scrollable space below.
          The inner .skeleton-scroll div holds the actual skeleton blocks
          and is also absolute so it doesn't push the wrapper taller.
        */
        .skeleton-wrapper {
          position: absolute;
          top: 0;
        ...
        /* Logo divider row — mirrors the real logo-row exactly */
        .sk-logo-row {
          grid-column: 1/-1;
        ...
        /* CONTENT — always rendered in normal flow, fades in */
        ...
        .gallery-item:not(.center) .gallery-overlay {
        ...
        .gallery-item:not(.center):hover .gallery-overlay { opacity: 1; transform: translateY(0); }
        ...
        .gallery-item.center .center-inner .gallery-overlay {
          position: absolute; bottom: 0; left: 0; right: 0;
          background: linear-gradient(to top, rgba(0,0,0,0.78), rgba(0,0,0,0.18) 70%, transparent);
          padding: 35px 30px; opacity: 0; transform: translateY(25px);
          transition: all 0.4s cubic-bezier(0.22,1,0.36,1);
        }
        .gallery-item.center .center-inner:hover .gallery-overlay { opacity: 1; transform: translateY(0); }
        ...
        @media (max-width: 768px) {
          ...
          .gallery-item:not(.center) .gallery-overlay { opacity: 0; transform: translateY(20px); transition: none; padding: 16px 14px; }
          .gallery-item.center .center-inner .gallery-overlay { opacity: 0; transform: translateY(20px); transition: none; padding: 16px 14px; }
          :global(.gallery-item.in-center) .gallery-overlay { animation: fadeInUpMobile 0.45s cubic-bezier(0.22,1,0.36,1) forwards; }
          :global(.gallery-item.center.in-center) .center-inner .gallery-overlay { animation: fadeInUpMobile 0.45s cubic-bezier(0.22,1,0.36,1) forwards; }
      ...
      <div className="page-root">
          ...
          <div className="skeleton-scroll">
            ...
            <div className="sk-gallery-section">
              ...
              <div className="sk-grid">
                ...
                {/* ── SWAROVSKI ── logo + center + h + h + center */}
                <div className="sk-logo-row"><div className="sk-logo-rule left" /><div className="sk-logo-center"><div className="sk-logo-block" /><span className="sk-logo-x">×</span><div className="sk-logo-block" style={{ width: 80, opacity: 0.5 }} /></div><div className="sk-logo-rule right" /></div>
                ...
                {/* ── MASSIMO DUTTI ── logo + h + h + center */}
                <div className="sk-logo-row"><div className="sk-logo-rule left" /><div className="sk-logo-center"><div className="sk-logo-block" /><span className="sk-logo-x">×</span><div className="sk-logo-block" style={{ width: 80, opacity: 0.5 }} /></div><div className="sk-logo-rule right" /></div>
                <div className="sk-card horizontal" style={{ animationDelay: '0.00s' }} />
                <div className="sk-card horizontal" style={{ animationDelay: '0.06s' }} />
                <div className="sk-center-row"><div className="sk-center-card" style={{ animationDelay: '0.12s' }} /></div>

                {/* ── PUMA ── logo + h + h + center */}
                <div className="sk-logo-row"><div className="sk-logo-rule left" /><div className="sk-logo-center"><div className="sk-logo-block" /><span className="sk-logo-x">×</span><div className="sk-logo-block" style={{ width: 80, opacity: 0.5 }} /></div><div className="sk-logo-rule right" /></div>
                <div className="sk-card horizontal" style={{ animationDelay: '0.00s' }} />
                <div className="sk-card horizontal" style={{ animationDelay: '0.06s' }} />
                <div className="sk-center-row"><div className="sk-center-card" style={{ animationDelay: '0.12s' }} /></div>

                {/* ── DYSON ── logo + h + h + center */}
                <div className="sk-logo-row"><div className="sk-logo-rule left" /><div className="sk-logo-center"><div className="sk-logo-block" /><span className="sk-logo-x">×</span><div className="sk-logo-block" style={{ width: 80, opacity: 0.5 }} /></div><div className="sk-logo-rule right" /></div>
                <div className="sk-card horizontal" style={{ animationDelay: '0.00s' }} />
                <div className="sk-card horizontal" style={{ animationDelay: '0.06s' }} />
                <div className="sk-center-row"><div className="sk-center-card" style={{ animationDelay: '0.12s' }} /></div>

                {/* ── OAKLEY | META ── logo + h + h + center */}
                <div className="sk-logo-row"><div className="sk-logo-rule left" /><div className="sk-logo-center"><div className="sk-logo-block" /><span className="sk-logo-x">×</span><div className="sk-logo-block" style={{ width: 80, opacity: 0.5 }} /></div><div className="sk-logo-rule right" /></div>
                <div className="sk-card horizontal" style={{ animationDelay: '0.00s' }} />
                <div className="sk-card horizontal" style={{ animationDelay: '0.06s' }} />
                <div className="sk-center-row"><div className="sk-center-card" style={{ animationDelay: '0.12s' }} /></div>
                ...
                {/* ── GULLY LABS ── logo + center + h + h */}
                <div className="sk-logo-row"><div className="sk-logo-rule left" /><div className="sk-logo-center"><div className="sk-logo-block" /><span className="sk-logo-x">×</span><div className="sk-logo-block" style={{ width: 80, opacity: 0.5 }} /></div><div className="sk-logo-rule right" /></div>
                <div className="sk-center-row"><div className="sk-center-card" style={{ animationDelay: '0.00s' }} /></div>
                <div className="sk-card horizontal" style={{ animationDelay: '0.06s' }} />
                <div className="sk-card horizontal" style={{ animationDelay: '0.12s' }} />

                {/* ── MONKEY SHOULDER ── logo + center + h + h + center */}
                <div className="sk-logo-row"><div className="sk-logo-rule left" /><div className="sk-logo-center"><div className="sk-logo-block" /><span className="sk-logo-x">×</span><div className="sk-logo-block" style={{ width: 80, opacity: 0.5 }} /></div><div className="sk-logo-rule right" /></div>
                <div className="sk-center-row"><div className="sk-center-card" style={{ animationDelay: '0.00s' }} /></div>
                <div className="sk-card horizontal" style={{ animationDelay: '0.06s' }} />
                <div className="sk-card horizontal" style={{ animationDelay: '0.12s' }} />
                ...
                {/* ── PHILIPS INDIA ── logo + center + center */}
                <div className="sk-logo-row"><div className="sk-logo-rule left" /><div className="sk-logo-center"><div className="sk-logo-block" /><span className="sk-logo-x">×</span><div className="sk-logo-block" style={{ width: 80, opacity: 0.5 }} /></div><div className="sk-logo-rule right" /></div>
                <div className="sk-center-row"><div className="sk-center-card" style={{ animationDelay: '0.00s' }} /></div>
                <div className="sk-center-row"><div className="sk-center-card" style={{ animationDelay: '0.06s' }} /></div>

                {/* ── NANDU'S ── logo + h + h + center + h + h + center */}
                <div className="sk-logo-row"><div className="sk-logo-rule left" /><div className="sk-logo-center"><div className="sk-logo-block" /><span className="sk-logo-x">×</span><div className="sk-logo-block" style={{ width: 80, opacity: 0.5 }} /></div><div className="sk-logo-rule right" /></div>
                <div className="sk-card horizontal" style={{ animationDelay: '0.00s' }} />
                <div className="sk-card horizontal" style={{ animationDelay: '0.06s' }} />
                <div className="sk-center-row"><div className="sk-center-card" style={{ animationDelay: '0.12s' }} /></div>
        ...
        {/* ── CONTENT: normal flow, always rendered ── */}
                  ...
                  return (
                    <div key={index} className="gallery-item center">
                      <div className="center-inner">
                        <Image src={image.src} alt={image.title} width={image.width} height={image.height} priority quality={100} unoptimized style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
